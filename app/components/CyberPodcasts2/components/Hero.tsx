...
import cyberCrime from "@/public/assests/images/cybercrimepodcast.png"
import w3 from "@/public/assests/images/whatappScam3.png"
...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-paper mt-28">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-editorial flex-1 flex-col px-6 pt-16 md:px-10 lg:flex-row lg:items-center lg:pt-8">
        ...
        <div className="lg:w-[52%]">
          ...
          >
            ...
            LIVE AWARENESS SERIES &middot; MADHYA PRADESH &middot; Bhopal
          </motion.div>
          ...
          >
            ...
            <a
              ...
              className="font-display text-sm font-semibold text-navy-900 underline decoration-white decoration-2 underline-offset-4 hover:text-cyber-700"
            >
        ...
        <div className="relative mt-16 lg:mt-0 lg:w-[48%]">
          ...
          >
            <div className="font-display text-2xl font-extrabold text-zinc-500">{stats[0].value}</div>
      ...
      {/* bottom scroll cue */}
      <div className="relative z-10 mx-auto w-full max-w-editorial px-6 pb-6 pt-10 md:px-12">
        <div className="signal-rule" />
        <div className="mt-4 flex justify-between">
          <span className="eyebrow text-navy-400">SCROLL TO EXPLORE</span>
          <span className="eyebrow text-navy-400">EST. 2024 — BHOPAL, INDIA</span>
        </div>
      </div>
    </section>
  )
